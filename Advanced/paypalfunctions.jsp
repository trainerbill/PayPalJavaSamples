...
<%
	...
	*/
	...
	gv_APIUser	= "xxxxxx"; //merchant login name
	//Fill in the gv_APIPassword variable yourself, the wizard will not do this automatically
	gv_APIPassword	= "xxxxxxxx"; //password associated with manager.paypal.com account
	gv_APIVendor = "xxxxxx"; //merchant login name
...
<%!
	...
	******************************************************************************** */
	public HashMap httpcall( String nvpStr, String unique_id )
	{
        ...
        public HashMap getSecureToken(String paymentType, String paymentAmount, String firstName, String lastName, String street, String city, String state, String zip, String countryCode, String currencyCode, String orderdescription)
		{
				...
				nvpstr = nvpstr + "&NAME=" + firstName +"&STREET=" + street + "&CITY=" + city;
				nvpstr = nvpstr + "&STATE=" + state + "&ZIP=" + zip + "&COUNTRY=" + countryCode;
				nvpstr = nvpstr + "&INVNUM=" + uid.toString() + "&ORDERDESC=" + orderdescription;
				nvpstr = nvpstr + "&CREATESECURETOKEN=Y&MODE=Test&RETURNURL=http://127.0.0.1:7101/PayFlow-PayFlowEC-context-root/newfinalpage.jsp&CANCELURL=http://127.0.0.1:7101/PayFlow-PayFlowEC-context-root/newfinalpage.jsp&SECURETOKENID="+uid_securetokenid;
				/*
